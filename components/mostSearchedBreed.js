...
export default function MostSearchedBreed() {
  ...
  return (
    <div className='sm:max-w-[1280px] w-fit grid sm:grid-cols-4 grid-cols-2 mx-auto mt-14 sm:gap-[140px] gap-x-[65px] pb-[22px]'>
        {topBreedImages.map((cat,index)=>(
          <div className='flex flex-col justify-center '>
            ...
            >
              <img src={cat.imageUrl} key={index} className='sm:w-[220px] w-[135px] sm:h-[220px] h-[135px] rounded-[20px] shadow-[10px_10px_10px_5px_rgba(0,0,0,0.5)]'/>
            </Link>
            <p className="[font-family:'Montserrat-SemiBold',Helvetica] font-semibold text-[#291507] text-[18px] mt-4 sm:mb-32 mb-[45px] h-fit">{cat.breedName}</p>
          </div>
